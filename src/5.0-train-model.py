...
def main(config):
    ...
    for epoch in range(config.num_epochs):
        ...
        for phase in phases:
            ...
            # save model
            if epoch == config.num_epochs - 1 or (epoch+1) % config.save_model_interval == 0:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_model_interval', type=int, default=1, help='interval to save model')
